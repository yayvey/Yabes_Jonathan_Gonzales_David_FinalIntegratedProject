(function($) {
  ...
  if (isInBypass < 0) {
    ...
    if (!window.name && $.cookie("AV") !== "fail" && drupalSettings.user.uid === 0) {
...
"use strict";!function(r){r(".paragraph--type--cl-video-slider .slides").each(function(){r(this).slick({appendArrows:r(this).parent().find(".navigation"),nextArrow:'<button type="button" class="btn-round slick-next" aria-label="Next"><span><i aria-hidden="true" class="cli-arrow-next"></i></span></button>',prevArrow:'<button type="button" class="btn-round slick-prev" aria-label="Previous"><span><i aria-hidden="true" class="cli-arrow-prev"></i></span></button>'}),r(this).on("setPosition",function(){r(".cl-video-slide-preview video").each(function(){r(this).get(0).muted=!0})})}),r(document).ready(function(){r(".paragraph--type--cl-video-slider .paragraph--type--cl-video-slide-content").each(function(){r(this).find(".cl-video-slide-preview");var e=r(this).find(".cl-video-slide-full"),t=r(this).find(".cl-video-slide-full").find("video"),i=(t[0],t.attr("id"),r(this).find(".play-fullscreen")),n=r(this).find(".runtime"),l=0;t[0]&&(l=t[0].duration),i.hasClass("link")||i.featherlight(e,{afterOpen:function(){var e,t=r(".featherlight-content video"),i=r(".featherlight-content iframe");0<t.length&&((e=t[0]).controls=!0,e.loop=!1,e.muted=!1,e.play(),(e=t[0]).requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen&&e.msRequestFullscreen()),0<i.length&&(e=(e=i.prop("src")).replace("autoplay=0","autoplay=1"),i.prop("src",e))},beforeClose:function(){var e,t=r(".featherlight-content video"),i=r(".featherlight-content iframe");0<t.length&&((e=t[0]).pause(),e.muted=!0),0<i.length&&(e=(e=i.prop("src")).replace("autoplay=1","autoplay=0"),i.prop("src",e))}}),l&&n.html(Math.floor(l/60)+":"+("0"+Math.floor(l%60)).slice(-2))})})}(jQuery);;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
...
(function($) {
  ...
  $(document).ready(function() {
    ...
    if (
      ...
      $.cookie("AV") &&
      $.cookie("selectLanguage") !== drupalSettings.path.currentLanguage
    ) {
      if (valid === true && $.cookie("selectLanguage") !== "en") {
        cookieLang = $.cookie("selectLanguage").split("-")[1];
        if (switchLangCode !== cookieLang) {
          if (splittedPath) {
            window.location.replace(
              document.location.origin +
                "/" +
                $.cookie("selectLanguage") +
                "/" +
                splittedPath
            );
          } else {
            window.location.replace(
              document.location.origin + "/" + $.cookie("selectLanguage")
            );
          }
        }
      } else if ($.cookie("selectLanguage") === "en") {
        if (splittedPath) {
          window.location.replace(
  ...
  Drupal.behaviors.mc_popup = {
    attach: function (context, settings) {
      ...
      $('.block-mc-popup', context).each(function(){
        ...
        $(this).findOnce('.subscribe-button').click(function(e){
          e.preventDefault();
      ...
      function mc_minimize(action, popId){
        if(action == true){
          $('#'+popId+'.block-mc-popup .mc_popup_container', context).removeClass('open');
          $('#'+popId+'.block-mc-popup .mc_popup_minimized', context).removeClass('hidden');
        } else {
          $('#'+popId+'.block-mc-popup .mc_popup_container', context).addClass('open');
